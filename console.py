#!/usr/bin/python3
"""A script that defines the HBnB console."""
import cmd
import re
...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """Method that does nothing upon receiving an empty line"""
        pass

    def default(self, arg):
        """creates the default behavior for cmd module when input is invalid"""
        argdict = {
            "all": self.do_all,
            "show": self.do_show,
